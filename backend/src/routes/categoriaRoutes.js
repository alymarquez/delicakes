...
router.get('/', validarJWT, validarRol('admin'), categoriaController.obtenerCategorias)
router.get('/:id', validarJWT, validarRol('admin'), existeCategoria, categoriaController.obtenerCategoria)
