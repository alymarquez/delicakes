...
const { existePedido } = require('../middlewares/validarExistencia')
...
router.post('/', validarJWT, validarRol('usuario', 'admin'), validarPedido, pedidoController.crearPedido)
router.put('/:id', validarJWT, validarRol('admin'), existePedido, validarPedido, pedidoController.actualizarPedido)
